...
export default function Home() {
  ...
  return (
    <>
      ...
      <section
        id="home"
        className="min-h-screen flex items-center justify-center bg-white dark:bg-black text-black dark:text-white transition-all duration-300 px-8 py-8"
      >
      ...
      <section
        id="about"
        className="relative min-h-[60vh] flex items-center justify-center bg-white dark:bg-black text-black dark:text-white px-6 py-16 overflow-hidden"
      >
